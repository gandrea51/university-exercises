...
class Unet(SegmentationModel):
    ...
    def __init__(self, 
                 encoder_name: str = 'mit_b2', encoder_depth: int = 4, encoder_weights: Optional[str] = 'imagenet',
                 decoder_use_batchnorm: bool = True, decoder_channels: List[int] = (256, 128, 64, 32),
